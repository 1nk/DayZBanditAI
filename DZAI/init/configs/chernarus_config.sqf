...
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,1,75,300,275,1,thisTrigger] call fnc_spawnBandits_bldgs;", ""];
_trigger_0 = _this;
...
_this setTriggerTimeout [30, 60, 90, true];
_this setTriggerText "DZAI Trigger";
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [1,2,75,300,275,1,thisTrigger] call fnc_spawnBandits_bldgs;", ""];
_trigger_4 = _this;

_this = createTrigger ["EmptyDetector", [4881.9443, 2838.9971, 0]];
_this setTriggerArea [325, 325, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 60, 90, true];
_this setTriggerText "DZAI Trigger";
...
_this setTriggerTimeout [30, 60, 90, true];
_this setTriggerText "DZAI Trigger";
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [2,1,75,300,275,1,thisTrigger] call fnc_spawnBandits_bldgs;", ""];
_trigger_10 = _this;
...
_this setTriggerTimeout [30, 60, 90, true];
_this setTriggerText "DZAI Trigger";
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [3,1,75,300,275,1,thisTrigger] call fnc_spawnBandits_bldgs;", ""];
_trigger_12 = _this;
...
_this = createTrigger ["EmptyDetector", [10151.673, 1855.5569, 3.4404879]];
_this setTriggerArea [325, 325, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 60, 90, true];
_this setTriggerText "DZAI Trigger";
...
_this = createTrigger ["EmptyDetector", [9164.4277, 3832.1824, 0]];
_this setTriggerArea [325, 325, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 60, 90, true];
_this setTriggerText "DZAI Trigger";
...
_this = createTrigger ["EmptyDetector", [10007.653, 10376.338, 0]];
_this setTriggerArea [325, 325, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 60, 90, true];
_this setTriggerText "DZAI Trigger";
...
_this = createTrigger ["EmptyDetector", [11229.258, 6582.5464, 0]];
_this setTriggerArea [325, 325, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 60, 90, true];
_this setTriggerText "DZAI Trigger";
