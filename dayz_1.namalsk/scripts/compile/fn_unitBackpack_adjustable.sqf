...
*/
        ...
        _bags = ["DZ_Patrol_Pack_EP1", "DZ_Assault_Pack_EP1", "DZ_CivilBackpack_EP1", "DZ_ALICE_Pack_EP1", "DZ_Backpack_EP1", "BAF_AssaultPack_DZN"]; //Possible types of backpacks to assign
		//_tools = ["ItemWatch","ItemKnife","ItemCompass","ItemMap","ItemToolbox","ItemMatchbox"];	//Unused; tool selection is now hardcoded
		_gadgets = ["ItemGPS","NVGoggles","binocular_vector","ItemFlashlightRed","BrokenItemGPS","BrokenNVGoggles","BrokenItemRadio"]; //Possible gadgets to assign
