//Reconfiguration for Taviana (Incomplete)
...
_this = createTrigger ["EmptyDetector", [15280.69, 9266.6514]];
_this setTriggerArea [325, 325, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 60, 90, true];
_this setTriggerText "DZAI Trigger";
...
_this = createTrigger ["EmptyDetector", [15594.151, 9563.6484, 12.227304]];
_this setTriggerArea [325, 325, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 60, 90, true];
_this setTriggerText "DZAI Trigger";
...
_this setTriggerTimeout [30, 60, 90, true];
_this setTriggerText "DZAI Trigger";
_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,1,75,300,250,1,thisTrigger] call fnc_spawnBandits_bldgs;", ""];
_trigger_78 = _this;
