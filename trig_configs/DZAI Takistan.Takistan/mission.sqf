...
if (true) then
{
  _this = _group_0 createUnit ["Dog1", [7667.1401, 1320.9893, 0], [], 0, "CAN_COLLIDE"];
  _unit_0 = _this;
...
_this = createTrigger ["EmptyDetector", [3666.9441, 4408.271]];
_this setTriggerArea [200, 200, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 45, 60, true];
_this setTriggerText "DZAI Trigger";
...
_this = createTrigger ["EmptyDetector", [3288.6462, 3763.8145]];
_this setTriggerArea [200, 200, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 45, 60, true];
_this setTriggerText "DZAI Trigger";
...
_this = createTrigger ["EmptyDetector", [3195.0132, 8187.7471]];
_this setTriggerArea [200, 200, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 45, 60, true];
_this setTriggerText "DZAI Trigger";
...
_this = createTrigger ["EmptyDetector", [10973.281, 2452.8206, 0]];
_this setTriggerArea [200, 200, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 45, 60, true];
_this setTriggerText "DZAI Trigger";
...
_this = createTrigger ["EmptyDetector", [8215.832, 2116.011, 0]];
_this setTriggerArea [200, 200, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 45, 60, true];
_this setTriggerText "DZAI Trigger";
...
_this = createTrigger ["EmptyDetector", [5262.3799, 6127.6558]];
_this setTriggerArea [200, 200, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 45, 60, true];
_this setTriggerText "DZAI Trigger";
...
_this = createTrigger ["EmptyDetector", [1815.7783, 11892.308, 0.42770386]];
_this setTriggerArea [200, 200, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 45, 60, true];
_this setTriggerText "DZAI Trigger";
...
_this = createTrigger ["EmptyDetector", [9854.5938, 11497.674, 7.6293945e-006]];
_this setTriggerArea [200, 200, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 45, 60, true];
_this setTriggerText "DZAI Trigger";
...
_this = createTrigger ["EmptyDetector", [10465.164, 11073.084, 0]];
_this setTriggerArea [200, 200, 0, false];
_this setTriggerActivation ["ANY", "PRESENT", false];
_this setTriggerTimeout [30, 45, 60, true];
_this setTriggerText "DZAI Trigger";
