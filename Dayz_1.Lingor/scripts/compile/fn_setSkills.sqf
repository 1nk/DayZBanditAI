...
_unit setSkill ["aimingShake",(0.15 + random 0.50)];
...
_unit setSkill ["reloadSpeed",(0.50 + random 0.50)];
_unit setSkill ["commanding",(0.50 + random 0.50)];
_unit setSkill ["general",(0.50 + random 0.50)];
