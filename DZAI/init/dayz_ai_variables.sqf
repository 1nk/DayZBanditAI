//DayZ AI Module Revision 1 (DZAI) Version 0.01
private["_worldname"];


//Enable/Disable Zombies
DZAI_zombiesDisabled = false;			//Disable zombie spawns (0: Zombies, 1: No Zombies)
DZAI_wildzombiesDisabled = false;		//Disable wilderness zombie spawns
...
//AI Variables
DZAI_spawnMultiplier = 1;			//AI spawn multiplier (Default value: 1, whole numbers only. Recommended settings: 1 with Zombies enabled, 2-4 with Zombies disabled)
DZAI_weaponNoise = 1.0;				//Multiplier value for AI weapon noise. (Player equivalent: 1.0)
DZAI_noRifleChance = 0.10;			//Chance of not assigning any rifle to the AI if weapongrade is zero.
DZAI_heliCrashChance = 0.070;		//Chance of assigning a helicrash weapon to the AI (should be smaller than DZAI_betterWeapon) (NO LONGER USED)
DZAI_betterWeapon = 0.25;			//Chance of assigning a better weapon to the AI than the preset weapon grade. (NO LONGER USED)
DZAI_betterBackPack = 0.87;			//Chance of assigning a better backpack to the AI than the default one.

//AI Spawn Limits
DZAI_maxAIUnits = 65535;			//Global maximum number of spawned AI bandits

//AI Respawn Timing
DZAI_respawnTime1 = 120;			//Minimum wait time for AI respawn timer (seconds).
...
DZAI_miscItemChance = 0.5;			//Chance to add random item from DZAI_DefaultMiscs table.
DZAI_skinItemChance = 0.085;		//Chance to add random item from DZAI_DefaultSkinLoot table.
DZAI_maxPistolMags = 2;				//Maximum number of pistol magazines to generate (Note: AI may loot additional magazines from dead bodies they find)
DZAI_maxRifleMags = 3;				//Maximum number of rifle  magazines to generate (Note: AI may loot additional magazines from dead bodies they find)
...
DZAI_gradeChances = [0.12,0.55,0.25,0.08]; //Probabilities for generating weapon grades (0 - 3).
