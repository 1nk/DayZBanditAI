...
*/
        ...
        _bags = ["DZ_Patrol_Pack_EP1", "DZ_Assault_Pack_EP1", "DZ_CivilBackpack_EP1", "DZ_ALICE_Pack_EP1", "DZ_Backpack_EP1""];
        _equips = ["ItemGPS", "NVGoggles", "ItemToolbox", "ItemMatchbox", "ItemEtool", "ItemCompass", "ItemWatch", "ItemFlashlightRed", "ItemKnife", "binocular_vector", "binocular"];
