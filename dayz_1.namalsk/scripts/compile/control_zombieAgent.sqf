...
_isSomeone = ({((isPlayer _x) || (typeOf _x == "Survivor2_DZ")||(typeOf _x == "SurvivorW2_DZ")||(typeOf _x == "Survivor3_DZ")||(typeOf _x == "Bandit1_DZ")||(typeOf _x == "BanditW1_DZ")||(typeOf _x == "Camo1_DZ")||(typeOf _x == "Sniper1_DZ")||(typeOf _x == "Sniper1W_DZN")||(typeOf _x == "CamoWinter_DZN")||(typeOf _x == "CamoWinterW_DZN"))} count _list) > 0;
