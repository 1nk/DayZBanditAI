...
aiRespawnChance = 0.25;			//Probability of respawning an AI upon death
aiNoRifleChance = 0.50;			//Probability of not assigning any rifle to the AI if weapongrade is zero.
aiHeliCrashChance = 0.05;		//Probability of assigning a helicrash weapon to the AI (should be smaller than aiBetterWeapon)
aiBetterWeapon = 0.15;			//Probability of assigning a better weapon to the AI than the preset weapon grade.

maxAI1Rate = 5;					//Global maximum wait time before randomly-spawned AI script can be run again (minutes)
maxAI2Rate = 5;					//Global maximum wait time before building-spawned AI script can be run again (minutes)
