...
*/
	...
	_edibles = ["ItemSodaCoke", "ItemSodaPepsi", "ItemWaterbottle", "FoodCanSardines", "FoodCanBakedBeans", "FoodCanFrankBeans", "FoodCanPasta", "FoodSteakCooked", "FoodSteakRaw", "ItemWaterbottleUnfilled"];
	_medicals1 = ["ItemBandage", "ItemPainkiller"];
	_medicals2 = ["ItemMorphine", "ItemBandage", "ItemBloodbag", "ItemPainkiller", "ItemAntibiotic"];
	_miscs = ["ItemSandbag", "ItemTent", "ItemJerrycan", "PartWheel", "PartEngine", "PartFueltank", "ItemTankTrap", "ItemWire", "PartGlass", "PartVRotor", "TrapBear", "Skin_Camo1_DZ", "Skin_Sniper1_DZ", "Skin_CamoWinterW_DZN", "Skin_Sniper1W_DZN", "Skin_CamoWinter_DZN", "ItemHeatpack", "HandRoadFlare", "HandChemBlue", "HandChemRed", "HandChemGreen"];
	...
	_bpedi1 =  floor random 2;
	_bpedi2 =  floor random 3;
	_bpmedi1 = floor random 2;
	_bpmedi2 = floor random 3;
